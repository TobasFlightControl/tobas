...
int main()
{
  ...
  a1::payload::NAV_COV cov;
  a1::payload::NAV_HPPOSLLH hpposllh;
  a1::payload::NAV_POSLLH posllh;
  a1::payload::NAV_PVT pvt;
  a1::payload::NAV_STATUS status;
  a1::payload::NAV_TIMEGPS timegps;
  a1::payload::NAV_VELNED velned;
  ...
  // Enable messages
  if (!gnss.enableMsg(a1::ZEDF9P::CLASS_NAV, a1::ZEDF9P::NAV_COV, true))
  {
    cerr << "Failed to enable NAV_COV message." << endl;
    return EXIT_FAILURE;
  }
  if (!gnss.enableMsg(a1::ZEDF9P::CLASS_NAV, a1::ZEDF9P::NAV_HPPOSLLH, true))
  {
    cerr << "Failed to enable NAV_HPPOSLLH message." << endl;
    return EXIT_FAILURE;
  }
  if (!gnss.enableMsg(a1::ZEDF9P::CLASS_NAV, a1::ZEDF9P::NAV_POSLLH, true))
  {
    cerr << "Failed to enable NAV_POSLLH message." << endl;
    return EXIT_FAILURE;
  }
  if (!gnss.enableMsg(a1::ZEDF9P::CLASS_NAV, a1::ZEDF9P::NAV_PVT, true))
  {
    cerr << "Failed to enable NAV_PVT message." << endl;
    return EXIT_FAILURE;
  }
  if (!gnss.enableMsg(a1::ZEDF9P::CLASS_NAV, a1::ZEDF9P::NAV_STATUS, true))
  {
    cerr << "Failed to enable NAV_STATUS message." << endl;
    return EXIT_FAILURE;
  }
  if (!gnss.enableMsg(a1::ZEDF9P::CLASS_NAV, a1::ZEDF9P::NAV_TIMEGPS, true))
  {
    cerr << "Failed to enable NAV_TIMEGPS message." << endl;
    return EXIT_FAILURE;
  }
  if (!gnss.enableMsg(a1::ZEDF9P::CLASS_NAV, a1::ZEDF9P::NAV_VELNED, true))
  {
  ...
  while (true)
  {
    ...
    if (gnss.latestClass() != a1::ZEDF9P::CLASS_NAV)
      continue;
    ...
    switch (gnss.latestId())
    {
      ...
      case a1::ZEDF9P::NAV_HPPOSLLH:
        ...
        cout << hpposllh << endl;
        break;
      case a1::ZEDF9P::NAV_POSLLH:
        posllh.decode(gnss.payload());
        cout << "[NAV_POSLLH]" << endl;
        cout << posllh << endl;
        break;
      case a1::ZEDF9P::NAV_PVT:
