...
{
  const bool check_revolute = revolute_threshold > 0.;
...
{
  rcpputils::require_true(relative_factor > 1.);
...
{
  rcpputils::require_true(revolute > 0.);
  rcpputils::require_true(prismatic > 0.);
