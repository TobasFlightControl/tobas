...
void RosQtBridge::initialize(const std::string& ns)
{
  ...
  add<tobas_msgs::msg::RCInput, &self::rcInputReceived>(ns, tobas::kRcInputTopic);
  add<tobas_msgs::msg::Gnss, &self::gnssReceived>(ns, tobas::kGnssTopic);
  ...
  add<tobas_msgs::msg::Odometry, &self::odomReceived>(ns, tobas::kOdometryTopic);
  ...
  add<tobas_msgs::msg::ImuStamped, &self::rawImuReceived>(ns, real::kImuTopic);
  add<tobas_msgs::msg::MagneticFieldStamped, &self::rawMagReceived>(ns, real::kMagTopic);
