...
void AvailableLinksWidget::removeLink(const QString& link_name)
{
  ...
  {
    auto link_widget = qobject_cast<AvailableLinkItemWidget*>(itemWidget(item(row)));
