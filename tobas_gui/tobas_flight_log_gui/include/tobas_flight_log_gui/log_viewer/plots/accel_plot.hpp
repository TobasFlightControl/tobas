...
private:
  ...
  std::array<qwt::QwtPlotCurveWrapper::SharedPtr, 3> cur_lin_curves_;
  std::array<qwt::QwtPlotCurveWrapper::SharedPtr, 3> cur_ang_curves_;
  std::array<qwt::QwtPlotCurveWrapper::SharedPtr, 3> tar_lin_curves_;
  std::array<qwt::QwtPlotCurveWrapper::SharedPtr, 3> tar_ang_curves_;
