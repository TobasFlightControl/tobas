    ...
    def _generate_drone_config(self, config_dir: str) -> None:
        ...
        for i in range(num_rotors):
            ...
            drone_config[f"rotor_{i}"] = {
                ...
                "motor_constant": float(selected.dynamics.motor_const()),
                "moment_constant": float(selected.dynamics.moment_const()),
                "drag_constant": float(selected.dynamics.rotor_drag_coef()),
                "channel": i,
            }
    ...
    def _add_xml_elements(self, robot: ET.Element) -> None:
        ...
        for i in range(self._main.propulsion_system.selected.count()):
            ...
            motor_model = MotorModel(
                ...
                motor_const=selected.dynamics.motor_const(),
                moment_const=selected.dynamics.moment_const(),
                rotor_drag_coef=selected.dynamics.rotor_drag_coef(),
