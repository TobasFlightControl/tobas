...
class SetupAssistant(Widget):
    ...
    def __init__(self) -> None:
        ...
        self.magnetometer = MagnetometerWidget(self)
        ...
        self.hardware = HardwareWidget(self)
        ...
        self._tab_widget.addTab(self.magnetometer, MagnetometerWidget.NAME)
        ...
        self._tab_widget.addTab(self.hardware, HardwareWidget.NAME)
