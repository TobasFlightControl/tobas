...
class ControllerWidget(BaseSettingWidget):
    ...
    MULTIROTOR_LMPC = "Linear Model Predictive Control"
    FIXED_WING_LQD = "Linear Quadratic Regulator"
    ...
    def __init__(self, main: SetupAssistant) -> None:
        ...
        self.controller_type.addItems([self.NO_SELECT, self.MULTIROTOR_LMPC])
        self.controller_type.setCurrentText(self.MULTIROTOR_LMPC)
    ...
    def is_valid(self) -> bool:
        ...
        if self.get_type() == self.MULTIROTOR_LMPC and (not self.lmpc.is_valid()):
            return False
    ...
    def pkg_name(self) -> str:
        ...
        elif controller_type == self.MULTIROTOR_LMPC:
