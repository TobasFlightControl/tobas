...
class AerodynamicsCoefficientsWidget(QWidget):
    ...
    def __init__(self, main: SetupAssistant) -> None:
        ...
        self.c_lift_0.setDecimals(self.DECIMALS)
        ...
        self.c_lift_alpha.setDecimals(self.DECIMALS)
        ...
        self.c_drag_0.setDecimals(self.DECIMALS)
        ...
        self.c_drag_alpha.setDecimals(self.DECIMALS)
        ...
        self.c_side_beta.setDecimals(self.DECIMALS)
        ...
        self.c_roll_beta.setDecimals(self.DECIMALS)
        ...
        self.c_roll_p.setDecimals(self.DECIMALS)
        ...
        self.c_roll_r.setDecimals(self.DECIMALS)
        ...
        self.c_pitch_0.setDecimals(self.DECIMALS)
        ...
        self.c_pitch_alpha.setDecimals(self.DECIMALS)
        ...
        self.c_pitch_abs_beta.setDecimals(self.DECIMALS)
        ...
        self.c_pitch_alpha_rate.setDecimals(self.DECIMALS)
        ...
        self.c_pitch_q.setDecimals(self.DECIMALS)
        ...
        self.c_yaw_beta.setDecimals(self.DECIMALS)
        ...
        self.c_yaw_p.setDecimals(self.DECIMALS)
        ...
        self.c_yaw_r.setDecimals(self.DECIMALS)
