...
void Vector3ToAngularVelocity(const geometry_msgs::Vector3& vec, multirotor_msgs::AngularVelocity& w);

void AngularVelocityToVector3(const multirotor_msgs::AngularVelocity& w, geometry_msgs::Vector3& vec);
