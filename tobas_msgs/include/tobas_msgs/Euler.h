...
typedef ::tobas_msgs::Euler_<std::allocator<void> > Euler;

typedef boost::shared_ptr< ::tobas_msgs::Euler> EulerPtr;
typedef boost::shared_ptr< ::tobas_msgs::Euler const> EulerConstPtr;
...
bool operator==(
  const ::tobas_msgs::Euler_<ContainerAllocator1>& lhs,
  const ::tobas_msgs::Euler_<ContainerAllocator2>& rhs)
{
