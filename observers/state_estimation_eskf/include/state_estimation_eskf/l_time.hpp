...
// this file is an approximation of the ros time class, though with no templating, reduced error
// checking and no fancy dependencies.
...
public:
  ...
  lTime(int32_t _sec, int32_t _nsec) : sec(_sec), nsec(_nsec)
  {
