...
typedef ::dh_kdl_msgs::Vector_<std::allocator<void> > Vector;

typedef boost::shared_ptr< ::dh_kdl_msgs::Vector> VectorPtr;
typedef boost::shared_ptr< ::dh_kdl_msgs::Vector const> VectorConstPtr;
}  // namespace dh_kdl_msgs
