#ifndef DH_KDL_MSGS_MESSAGE_ACCEL_H
#define DH_KDL_MSGS_MESSAGE_ACCEL_H
...
typedef ::dh_kdl_msgs::Accel_<std::allocator<void> > Accel;

typedef boost::shared_ptr< ::dh_kdl_msgs::Accel> AccelPtr;
typedef boost::shared_ptr< ::dh_kdl_msgs::Accel const> AccelConstPtr;
}  // namespace dh_kdl_msgs
...
#endif  // DH_KDL_MSGS_MESSAGE_ACCEL_H
