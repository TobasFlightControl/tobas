...
typedef ::dh_kdl_msgs::Twist_<std::allocator<void> > Twist;

typedef boost::shared_ptr< ::dh_kdl_msgs::Twist> TwistPtr;
typedef boost::shared_ptr< ::dh_kdl_msgs::Twist const> TwistConstPtr;
}  // namespace dh_kdl_msgs
