#ifndef DH_KDL_MSGS_MESSAGE_WRENCH_H
#define DH_KDL_MSGS_MESSAGE_WRENCH_H
...
typedef ::dh_kdl_msgs::Wrench_<std::allocator<void> > Wrench;

typedef boost::shared_ptr< ::dh_kdl_msgs::Wrench> WrenchPtr;
typedef boost::shared_ptr< ::dh_kdl_msgs::Wrench const> WrenchConstPtr;
}  // namespace dh_kdl_msgs
...
#endif  // DH_KDL_MSGS_MESSAGE_WRENCH_H
