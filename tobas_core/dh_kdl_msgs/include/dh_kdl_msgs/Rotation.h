...
#include <dh_kdl/rotation.hpp>

namespace dh_kdl_msgs
{
// using C++11 syntax KDL::Rotation and dh_kdl_msgs::Rotation_ are exactly the same type
template <typename ContainerAllocator>
using Rotation_ = KDL::Rotation;

typedef ::dh_kdl_msgs::Rotation_<std::allocator<void> > Rotation;

typedef boost::shared_ptr< ::dh_kdl_msgs::Rotation> RotationPtr;
typedef boost::shared_ptr< ::dh_kdl_msgs::Rotation const> RotationConstPtr;
}  // namespace dh_kdl_msgs
