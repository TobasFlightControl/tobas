...
/**
 * \brief This abstract class encapsulates the inverse position solver for a tobas_kdl::Tree.
 */
...
/**
 * \brief This abstract class encapsulates the inverse velocity solver for a tobas_kdl::Tree.
 */
