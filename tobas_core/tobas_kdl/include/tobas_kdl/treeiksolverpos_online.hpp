 ...
 * transformation from Cartesian to joint space of a general tobas_kdl::Tree. This class has been
...
private:
  ...
  /**
   * Scales the class member tobas_kdl::JntArray q_dot_, if one (or more) joint velocity exceeds the
  ...
  /**
   * Scales translational and rotational velocity vectors of the class member tobas_kdl::Twist
