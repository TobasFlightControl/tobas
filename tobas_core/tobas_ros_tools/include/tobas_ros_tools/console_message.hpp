...
#define rosInfoThrottle(period, name, msg) ROS_INFO_STREAM_THROTTLE(period, "[" << name << "] " << msg)
#define rosWarnThrottle(period, name, msg) ROS_WARN_STREAM_THROTTLE(period, "[" << name << "] " << msg)
#define rosErrorThrottle(period, name, msg) ROS_ERROR_STREAM_THROTTLE(period, "[" << name << "] " << msg)
#define rosFatalThrottle(period, name, msg) ROS_FATAL_STREAM_THROTTLE(period, "[" << name << "] " << msg)
