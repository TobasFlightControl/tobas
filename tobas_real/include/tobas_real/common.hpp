...
static constexpr char kConfigKey_RcModeAuto[] = "DEFAULT.rc_input/mode/auto";
static constexpr char kConfigKey_RcModePosition[] = "DEFAULT.rc_input/mode/position";
static constexpr char kConfigKey_RcModeSport[] = "DEFAULT.rc_input/mode/sport";
