...
void RCInputCalibrator::run()
{
  ...
  {
    // Left
    cout << "Please set the ROLL (CH" << tobas_real::kRcChannelRoll + 1
         << ") lever to LEFT and press Enter:";
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    roll_left = readRCInput(tobas_real::kRcChannelRoll);

    // Right
    cout << "Please set the ROLL (CH" << tobas_real::kRcChannelRoll + 1
         << ") lever to RIGHT and press Enter:";
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    roll_right = readRCInput(tobas_real::kRcChannelRoll);
  ...
  {
    // Up
    cout << "Please set the PITCH (CH" << tobas_real::kRcChannelPitch + 1
         << ") lever to UP and press Enter:";
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    pitch_up = readRCInput(tobas_real::kRcChannelPitch);

    // Down
    cout << "Please set the PITCH (CH" << tobas_real::kRcChannelPitch + 1
         << ") lever to DOWN and press Enter:";
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    pitch_down = readRCInput(tobas_real::kRcChannelPitch);
  ...
  {
    // Left
    cout << "Please set the YAW (CH" << tobas_real::kRcChannelYaw + 1
         << ") lever to LEFT and press Enter:";
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    yaw_left = readRCInput(tobas_real::kRcChannelYaw);

    // Right
    cout << "Please set the YAW (CH" << tobas_real::kRcChannelYaw + 1
         << ") lever to RIGHT and press Enter:";
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    yaw_right = readRCInput(tobas_real::kRcChannelYaw);
  ...
  {
    // Up
    cout << "Please set the THRUST (CH" << tobas_real::kRcChannelThrust + 1
         << ") lever to UP and press Enter:";
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    thrust_up = readRCInput(tobas_real::kRcChannelThrust);

    // Down
    cout << "Please set the THRUST (CH" << tobas_real::kRcChannelThrust + 1
         << ") lever to DOWN and press Enter:";
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    thrust_down = readRCInput(tobas_real::kRcChannelThrust);
  ...
  {
    // Up
    cout << "Please set the E-STOP (CH" << tobas_real::kRcChannelEStop + 1
         << ") to UP and press Enter:";
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    estop_up = readRCInput(tobas_real::kRcChannelEStop);

    // Down
    cout << "Please set the E-STOP (CH" << tobas_real::kRcChannelEStop + 1
         << ") to DOWN and press Enter:";
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    estop_down = readRCInput(tobas_real::kRcChannelEStop);
  ...
  {
    // Up
    cout << "Please set the GPSw (CH" << tobas_real::kRcChannelGPSw + 1
         << ") to UP and press Enter:";
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    gpsw_up = readRCInput(tobas_real::kRcChannelGPSw);

    // Down
    cout << "Please set the GPSw (CH" << tobas_real::kRcChannelGPSw + 1
         << ") to DOWN and press Enter:";
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    gpsw_down = readRCInput(tobas_real::kRcChannelGPSw);
  ...
  pt.put(tobas_real::kConfigKey_RcRollLeft, roll_left);
  pt.put(tobas_real::kConfigKey_RcRollRight, roll_right);
  pt.put(tobas_real::kConfigKey_RcPitchUp, pitch_up);
  pt.put(tobas_real::kConfigKey_RcPitchDown, pitch_down);
  pt.put(tobas_real::kConfigKey_RcYawLeft, yaw_left);
