...
void MagCalibrationRos::collectDataTimerCb(const ros::TimerEvent& event)
{
  ...
  {
    ROS_ERROR("The size of magnetic field vectors is over maximum. Data collection is stopped.");
    mag_data_.clear();
...
bool MagCalibrationRos::finishServiceCb(FinishSrvType::Request& req, FinishSrvType::Response& res)
{
  ...
  pt.put(tobas_real::kConfigKey_MagEllipseAxx, mag_trans_.a_xx);
  pt.put(tobas_real::kConfigKey_MagEllipseAyy, mag_trans_.a_yy);
  pt.put(tobas_real::kConfigKey_MagEllipseAzz, mag_trans_.a_zz);
  pt.put(tobas_real::kConfigKey_MagEllipseAxy, mag_trans_.a_xy);
  pt.put(tobas_real::kConfigKey_MagEllipseAyz, mag_trans_.a_yz);
  pt.put(tobas_real::kConfigKey_MagEllipseAzx, mag_trans_.a_zx);
  pt.put(tobas_real::kConfigKey_MagEllipseBx, mag_trans_.b_x);
  pt.put(tobas_real::kConfigKey_MagEllipseBy, mag_trans_.b_y);
  pt.put(tobas_real::kConfigKey_MagEllipseBz, mag_trans_.b_z);
  pt.put(tobas_real::kConfigKey_MagEllipseC, mag_trans_.c);
  pt.save();
