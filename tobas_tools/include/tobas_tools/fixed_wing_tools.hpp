...
struct VehicleParameters
{
  ...
  tobas_kdl::Vector ac;                  // Aerodynamic Center wrt the frame origin (NWU) [m]
 ...
 * @return double 迎角 [rad]
 */
double angleOfAttack(const tobas_kdl::Vector& linvel_B);
 ...
 * @return double 横滑り角 [rad]
 */
double angleOfSideSlip(const tobas_kdl::Vector& linvel_B);
