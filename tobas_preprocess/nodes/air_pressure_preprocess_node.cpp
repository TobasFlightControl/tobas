...
private:
  ...
  ros2::PublisherPtr<sensor_msgs::msg::FluidPressure> pres_pub_;
...
{
  pres_pub_ = createPublisher<sensor_msgs::msg::FluidPressure>(tobas::kAirPressureTopic);
...
void AirPressurePreprocessNode::presRawCb(const tobas_msgs::msg::FluidPressureRaw::ConstSharedPtr& pres_raw)
{
  ...
  // Create message
  auto pres_out = std::make_unique<sensor_msgs::msg::FluidPressure>();
